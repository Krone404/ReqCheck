...
# without POS tagging. Common protocol/format acronyms are listed explicitly to
# reduce false positives on constructions like "shall support TCP and UDP".
_STOPWORDS = {
    "a", "an", "the", "its", "their", "all", "any", "both", "each",
    "in", "on", "at", "to", "for", "of", "with", "by", "from",
    # Common networking / transport protocols
    "tcp", "udp", "http", "https", "ftp", "sftp", "smtp", "imap", "pop3",
    "tls", "ssl", "ssh", "dns", "dhcp", "snmp", "ldap", "ntp",
    # Data formats and encodings
    "json", "xml", "csv", "yaml", "pdf", "html", "jpeg", "png", "svg",
    "utf8", "ascii", "base64",
    # Common acronyms unlikely to begin a verb clause
    "api", "rest", "sql", "nosql", "jwt", "oauth", "saml", "totp",
    "aes", "rsa", "sha", "md5",
}
